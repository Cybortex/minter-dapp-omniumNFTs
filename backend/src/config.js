...
const namePrefix = "Mad Masked Furries";
const description = "The Mad Masked Furries (2M_Furries) collection is the first NFT collection from Omnium Meta. These are the OG OMNIC characters and are the first every created. They will reward holders with a lot of items as time goes on, so if you don't have one buy one.";
const baseUri = "ipfs://NewUriToReplace"; // This will be replaced automatically

// If you have selected Solana then the collection starts from 0 automatically
const layerConfigurations = [
  {
    growEditionSizeTo: 57,
    layersOrder: [
      { name: "2M furries artwork"},  
    ],
  }, 
  {
...
const extraMetadata = {
  external_url: "https://omniummeta.netlify.app/",
  external_url2: "https://omniummeta.com/", // Replace with your website or remove this line if you do not have one.
...
const PUBLIC_MINT_START_DATE = "2022-08-27T00:00:48+00:00"; // This is required. Eg: 2022-02-08T11:30:48+00:00

// OPTIONAL CONTRACT DETAILS THAT CAN BE UPDATED LATER.
const PRESALE_MINT_START_DATE = "2022-08-24T00:00:48+00:00"; // Optional. Eg: 2022-02-08T11:30:48+00:00
...
const PREREVEAL_TOKEN_URI = "ipfs://bafkreiarhadeolnpmotg32omh2mta7q55p2gzf72yezm7wztqorq5ieb4y"; // only update if you want to manually set the prereveal token uri
...
// ** OPTIONAL **
let CONTRACT_ADDRESS = "0xe344dDA59e42778eEdCEe84Ae726e5927A452C1b"; // If you want to manually include it
